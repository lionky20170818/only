 ...
 * Bean - 工具类
 */
public final class BeanCopierBeanUtils {
    private static final Logger LOG = LoggerFactory.getLogger(BeanCopierBeanUtils.class);
    /*
     * 用来缓存BeanCopier的缓存
     */
    ...
    // TODO 参考下
    //https://www.cnblogs.com/huaxingtianxia/p/5985913.html
    //https://ysj5125094.iteye.com/blog/2260885
    private BeanCopierBeanUtils() {
     ...
     *  TODO 仅支持对象之间拷贝，不支持MAP、LIST等
     *  TODO  不支持不同类型之间拷贝，如需支持，使用CommonTools.copyProperties()方法
     * @param source 源对象
     * @param target 目标对象
     */
